...
public class SpectrumAnalyzer : MonoBehaviour
{
    ...
    public float xPos = 0.003f; // X position
    public float zPos = 7.685f; // Y position
    ...
    void Update()
    {
        ...
        {
            float level = spectrum[i]*settings.pillar.sensitivity*Time.deltaTime*ScaleFactor; //0,1 = l,r for two channels
